...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.elemByIndex = function (index) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.find = function (selector) {
  ...
  for (; numOfItems < objLength; numOfItems++) {
    // Удаляем не перезаписанные значения.
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.addAttr = function (attr, value) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.showFlex = function () {
  for (let i = 0; i < this.length; i++) {
    if (!this[i].style) {
      continue;
    }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.on = function (event, func) {
  if (!event || !func) {
    return this;
  }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.off = function (event, func) {
  if (!event || !func) {
    return this;
  }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.click = function (func) {
  for (let i = 0; i < this.length; i++) {
    if (func) {
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])(".wrapper").showFlex();
